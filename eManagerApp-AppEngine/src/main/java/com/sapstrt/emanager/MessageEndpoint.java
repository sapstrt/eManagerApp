 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "sapstrt.com", ownerName = "sapstrt.com", packagePath = "emanager"))
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyACwEizAUnOwkQBXeY1tx8YKQ3FVlCj0N8";
